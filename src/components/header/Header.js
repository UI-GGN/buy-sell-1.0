...
const Header = ({isAuthenticated, onLogout, setSearchQuery}) => {
    ...
    return(
        <div>
            ...
            style={{textDecoration: 'none', marginInlineStart: "20px"}}
            onClick={() => routeHome()}
            >
                {(window.location.pathname === "/seller" || window.location.pathname === "/seller/register") 
                ? 
                <img className="sellers-logo" src={SellersPortalLogo} alt="Logo for CBP Sellers Portal"/> 
                : 
            ...
            <div className="icons-section">
                <div className="profile-icon">
                    ...
                    >
                        ...
                        <Dropdown
                        style={isAuthenticated ? {right: "80px"} : {right: "0px"}}
                        setShowDropdown={setShowDropdown}
                        >
                            {isAuthenticated ? username() : buttonSection()}
                            <hr/>
                            <div onClick={() => routeSeller()}><p>Seller Portal</p></div>
                ...
                <div className="inner-icons-section">
                    <div className="wishlist-icon">
                        ...
                        {window.location.pathname === "/my/wishlist" && <div className="indicator"></div>}
                    </div>
                    <div className="cart-icon">
                        ...
                        {window.location.pathname === "/my/cart" && <div className="indicator"></div>}
                    </div>
                </div>
                }
            </div>
