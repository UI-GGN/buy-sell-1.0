...
const Header = ({isLoggedIn, login, register}) => {

    const buttonSection = () => {
        return(
            <div className="button-section">
                <Button class="header-button" click={login}
                >
                    Login
                </Button>
                <Button class="header-button" click={register}
                >
                    Register
                </Button>
            </div>
    ...
    return(
        <nav className="header">
           ...
           {window.location.pathname === "/" && (!isLoggedIn && buttonSection())}
        </nav>
    )
}
